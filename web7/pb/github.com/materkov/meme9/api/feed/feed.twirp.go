...
func NewFeedProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Feed {
	...
	serviceURL += baseServicePath(pathPrefix, "meme.feed", "Feed")
	urls := [1]string{
		serviceURL + "GetFeed",
	}
...
func (c *feedProtobufClient) GetFeed(ctx context.Context, in *FeedRequest) (*FeedResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "meme.feed")
...
func (c *feedProtobufClient) callGetFeed(ctx context.Context, in *FeedRequest) (*FeedResponse, error) {
...
func (c *feedJSONClient) GetFeed(ctx context.Context, in *FeedRequest) (*FeedResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "meme.feed")
	ctx = ctxsetters.WithServiceName(ctx, "Feed")
	ctx = ctxsetters.WithMethodName(ctx, "GetFeed")
	caller := c.callGetFeed
...
func (c *feedJSONClient) callGetFeed(ctx context.Context, in *FeedRequest) (*FeedResponse, error) {
	out := new(FeedResponse)
...
const FeedPathPrefix = "/twirp/meme.feed.Feed/"
...
func (s *feedServer) serveGetFeed(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
...
func (s *feedServer) serveGetFeedJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetFeed")
		...
		handler = func(ctx context.Context, req *FeedRequest) (*FeedResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.Feed.GetFeed(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*FeedResponse)
...
func (s *feedServer) serveGetFeedProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetFeed")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *feedServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "meme.feed", "Feed")
}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}

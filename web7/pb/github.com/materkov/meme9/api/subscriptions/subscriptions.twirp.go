...
func (c *subscriptionsProtobufClient) Subscribe(ctx context.Context, in *SubscribeRequest) (*SubscribeResponse, error) {
...
func (c *subscriptionsProtobufClient) callSubscribe(ctx context.Context, in *SubscribeRequest) (*SubscribeResponse, error) {
...
func (c *subscriptionsProtobufClient) Unsubscribe(ctx context.Context, in *SubscribeRequest) (*SubscribeResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "meme.subscriptions")
	ctx = ctxsetters.WithServiceName(ctx, "Subscriptions")
...
func (c *subscriptionsProtobufClient) callUnsubscribe(ctx context.Context, in *SubscribeRequest) (*SubscribeResponse, error) {
	out := new(SubscribeResponse)
...
func (c *subscriptionsProtobufClient) GetStatus(ctx context.Context, in *SubscribeRequest) (*SubscribeResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "meme.subscriptions")
	ctx = ctxsetters.WithServiceName(ctx, "Subscriptions")
...
func (c *subscriptionsProtobufClient) callGetStatus(ctx context.Context, in *SubscribeRequest) (*SubscribeResponse, error) {
	out := new(SubscribeResponse)
...
func (c *subscriptionsJSONClient) Subscribe(ctx context.Context, in *SubscribeRequest) (*SubscribeResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "meme.subscriptions")
	ctx = ctxsetters.WithServiceName(ctx, "Subscriptions")
	ctx = ctxsetters.WithMethodName(ctx, "Subscribe")
	caller := c.callSubscribe
...
func (c *subscriptionsJSONClient) callSubscribe(ctx context.Context, in *SubscribeRequest) (*SubscribeResponse, error) {
	out := new(SubscribeResponse)
...
func (c *subscriptionsJSONClient) Unsubscribe(ctx context.Context, in *SubscribeRequest) (*SubscribeResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "meme.subscriptions")
	ctx = ctxsetters.WithServiceName(ctx, "Subscriptions")
	ctx = ctxsetters.WithMethodName(ctx, "Unsubscribe")
	caller := c.callUnsubscribe
...
func (c *subscriptionsJSONClient) callUnsubscribe(ctx context.Context, in *SubscribeRequest) (*SubscribeResponse, error) {
	out := new(SubscribeResponse)
...
func (c *subscriptionsJSONClient) GetStatus(ctx context.Context, in *SubscribeRequest) (*SubscribeResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "meme.subscriptions")
	ctx = ctxsetters.WithServiceName(ctx, "Subscriptions")
	ctx = ctxsetters.WithMethodName(ctx, "GetStatus")
	caller := c.callGetStatus
...
func (c *subscriptionsJSONClient) callGetStatus(ctx context.Context, in *SubscribeRequest) (*SubscribeResponse, error) {
	out := new(SubscribeResponse)
...
const SubscriptionsPathPrefix = "/twirp/meme.subscriptions.Subscriptions/"
...
func (s *subscriptionsServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "meme.subscriptions.Subscriptions" {
...
func (s *subscriptionsServer) serveSubscribe(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
...
func (s *subscriptionsServer) serveSubscribeJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Subscribe")
	...
	handler := s.Subscriptions.Subscribe
		...
		handler = func(ctx context.Context, req *SubscribeRequest) (*SubscribeResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.Subscriptions.Subscribe(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*SubscribeResponse)
...
func (s *subscriptionsServer) serveSubscribeProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Subscribe")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *subscriptionsServer) serveUnsubscribe(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *subscriptionsServer) serveUnsubscribeJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Unsubscribe")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	handler := s.Subscriptions.Unsubscribe
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *SubscribeRequest) (*SubscribeResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.Subscriptions.Unsubscribe(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*SubscribeResponse)
...
func (s *subscriptionsServer) serveUnsubscribeProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Unsubscribe")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *subscriptionsServer) serveGetStatus(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *subscriptionsServer) serveGetStatusJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetStatus")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	handler := s.Subscriptions.GetStatus
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *SubscribeRequest) (*SubscribeResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.Subscriptions.GetStatus(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*SubscribeResponse)
...
func (s *subscriptionsServer) serveGetStatusProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetStatus")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *subscriptionsServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "meme.subscriptions", "Subscriptions")
}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}

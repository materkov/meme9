...
export interface SubscriptionsClient {
  ...
  IsSubscribed(request: IsSubscribedRequest): Promise<IsSubscribedResponse>;
}
...
export class SubscriptionsClientJSON implements SubscriptionsClient {
  ...
  GetFollowing(request: GetFollowingRequest): Promise<GetFollowingResponse> {
    const data = GetFollowingRequest.toJson(request, {
      useProtoFieldName: true,
      emitDefaultValues: false,
    });
    const promise = this.rpc.request(
    ...
    return promise.then((data) =>
      GetFollowingResponse.fromJson(data as any, { ignoreUnknownFields: true })
    );
  }

  IsSubscribed(request: IsSubscribedRequest): Promise<IsSubscribedResponse> {
    const data = IsSubscribedRequest.toJson(request, {
      useProtoFieldName: true,
      emitDefaultValues: false,
    });
    const promise = this.rpc.request(
    ...
    return promise.then((data) =>
      IsSubscribedResponse.fromJson(data as any, { ignoreUnknownFields: true })
    );
  }
}
...
export class SubscriptionsClientProtobuf implements SubscriptionsClient {
  ...
  GetFollowing(request: GetFollowingRequest): Promise<GetFollowingResponse> {
    const data = GetFollowingRequest.toBinary(request);
    const promise = this.rpc.request(
      "meme.subscriptions.Subscriptions",
      "GetFollowing",
      "application/protobuf",
    ...
    return promise.then((data) =>
      GetFollowingResponse.fromBinary(data as Uint8Array)
    );
  }

  IsSubscribed(request: IsSubscribedRequest): Promise<IsSubscribedResponse> {
    const data = IsSubscribedRequest.toBinary(request);
    const promise = this.rpc.request(
      "meme.subscriptions.Subscriptions",
      "IsSubscribed",
      "application/protobuf",
    ...
    return promise.then((data) =>
      IsSubscribedResponse.fromBinary(data as Uint8Array)
    );
  }
}
...
export const SubscriptionsMethodList = [
  ...
  SubscriptionsMethod.GetFollowing,
  SubscriptionsMethod.IsSubscribed,
];
  ...
  switch (method) {
    ...
    case "GetFollowing":
      return async (
        ...
        ctx = { ...ctx, methodName: "GetFollowing" };
        await events.onMatch(ctx);
        return handleSubscriptionsGetFollowingRequest(
          ctx,
          service,
          data,
          interceptors
    ...
    case "IsSubscribed":
      return async (
        ...
        ctx = { ...ctx, methodName: "IsSubscribed" };
        await events.onMatch(ctx);
        return handleSubscriptionsIsSubscribedRequest(
          ctx,
          service,
          data,
          interceptors
...
function handleSubscriptionsGetFollowingRequest<
  T extends TwirpContext = TwirpContext
>(
  ctx: T,
  service: SubscriptionsTwirp,
  data: Buffer,
  interceptors?: Interceptor<T, GetFollowingRequest, GetFollowingResponse>[]
): Promise<string | Uint8Array> {
  switch (ctx.contentType) {
    case TwirpContentType.JSON:
      return handleSubscriptionsGetFollowingJSON<T>(
        ctx,
        service,
        data,
        interceptors
    ...
    case TwirpContentType.Protobuf:
      return handleSubscriptionsGetFollowingProtobuf<T>(
        ctx,
        service,
        data,
        interceptors
...
function handleSubscriptionsIsSubscribedRequest<
  T extends TwirpContext = TwirpContext
>(
  ctx: T,
  service: SubscriptionsTwirp,
  data: Buffer,
  interceptors?: Interceptor<T, IsSubscribedRequest, IsSubscribedResponse>[]
): Promise<string | Uint8Array> {
  switch (ctx.contentType) {
    case TwirpContentType.JSON:
      return handleSubscriptionsIsSubscribedJSON<T>(
        ctx,
        service,
        data,
        interceptors
    ...
    case TwirpContentType.Protobuf:
      return handleSubscriptionsIsSubscribedProtobuf<T>(
        ctx,
        service,
        data,
        interceptors
...
async function handleSubscriptionsGetFollowingJSON<
  T extends TwirpContext = TwirpContext
>(
  ctx: T,
  service: SubscriptionsTwirp,
  ...
  let request: GetFollowingRequest;
  let response: GetFollowingResponse;

  try {
    const body = JSON.parse(data.toString() || "{}");
    request = GetFollowingRequest.fromJson(body, { ignoreUnknownFields: true });
  } catch (e) {
    if (e instanceof Error) {
      const msg = "the json request could not be decoded";
      throw new TwirpError(TwirpErrorCode.Malformed, msg).withCause(e, true);
  ...
  if (interceptors && interceptors.length > 0) {
    ...
    >;
    response = await interceptor(ctx, request!, (ctx, inputReq) => {
      return service.GetFollowing(ctx, inputReq);
    });
  } else {
    response = await service.GetFollowing(ctx, request!);
  }

  return JSON.stringify(
    GetFollowingResponse.toJson(response, {
      useProtoFieldName: true,
      emitDefaultValues: false,
    }) as string
  );
...
async function handleSubscriptionsIsSubscribedJSON<
  T extends TwirpContext = TwirpContext
>(
  ctx: T,
  service: SubscriptionsTwirp,
  ...
  let request: IsSubscribedRequest;
  let response: IsSubscribedResponse;

  try {
    const body = JSON.parse(data.toString() || "{}");
    request = IsSubscribedRequest.fromJson(body, { ignoreUnknownFields: true });
  } catch (e) {
    if (e instanceof Error) {
      const msg = "the json request could not be decoded";
      throw new TwirpError(TwirpErrorCode.Malformed, msg).withCause(e, true);
  ...
  if (interceptors && interceptors.length > 0) {
    ...
    >;
    response = await interceptor(ctx, request!, (ctx, inputReq) => {
      return service.IsSubscribed(ctx, inputReq);
    });
  } else {
    response = await service.IsSubscribed(ctx, request!);
  }

  return JSON.stringify(
    IsSubscribedResponse.toJson(response, {
      useProtoFieldName: true,
      emitDefaultValues: false,
    }) as string
  );
...
async function handleSubscriptionsGetFollowingProtobuf<
  T extends TwirpContext = TwirpContext
>(
  ctx: T,
  service: SubscriptionsTwirp,
  ...
  try {
    request = GetFollowingRequest.fromBinary(data);
  } catch (e) {
    if (e instanceof Error) {
      const msg = "the protobuf request could not be decoded";
      throw new TwirpError(TwirpErrorCode.Malformed, msg).withCause(e, true);
  ...
  return Buffer.from(GetFollowingResponse.toBinary(response));
}

async function handleSubscriptionsIsSubscribedProtobuf<
  T extends TwirpContext = TwirpContext
>(
  ctx: T,
  service: SubscriptionsTwirp,
  ...
  try {
    request = IsSubscribedRequest.fromBinary(data);
  } catch (e) {
    if (e instanceof Error) {
      const msg = "the protobuf request could not be decoded";
      throw new TwirpError(TwirpErrorCode.Malformed, msg).withCause(e, true);
  ...
  return Buffer.from(IsSubscribedResponse.toBinary(response));
}

...
func easyjson8336a586DecodeGithubComMaterkovMeme9Web6Api4(in *jlexer.Lexer, out *ParagraphImage) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8336a586EncodeGithubComMaterkovMeme9Web6Api4(out *jwriter.Writer, in ParagraphImage) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != "" {
...
func easyjson8336a586DecodeGithubComMaterkovMeme9Web6Api5(in *jlexer.Lexer, out *Paragraph) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8336a586EncodeGithubComMaterkovMeme9Web6Api5(out *jwriter.Writer, in Paragraph) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Text != nil {
...
func easyjson8336a586DecodeGithubComMaterkovMeme9Web6Api6(in *jlexer.Lexer, out *ListPostedByUserReq) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8336a586EncodeGithubComMaterkovMeme9Web6Api6(out *jwriter.Writer, in ListPostedByUserReq) {
	out.RawByte('{')
	first := true
	_ = first
	if in.UserId != "" {
...
func easyjson8336a586DecodeGithubComMaterkovMeme9Web6Api7(in *jlexer.Lexer, out *InputParagraphText) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8336a586EncodeGithubComMaterkovMeme9Web6Api7(out *jwriter.Writer, in InputParagraphText) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Text != "" {
...
func easyjson8336a586DecodeGithubComMaterkovMeme9Web6Api8(in *jlexer.Lexer, out *InputParagraphImage) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8336a586EncodeGithubComMaterkovMeme9Web6Api8(out *jwriter.Writer, in InputParagraphImage) {
	out.RawByte('{')
	first := true
	_ = first
	if in.URL != "" {
...
func easyjson8336a586DecodeGithubComMaterkovMeme9Web6Api9(in *jlexer.Lexer, out *InputParagraph) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8336a586EncodeGithubComMaterkovMeme9Web6Api9(out *jwriter.Writer, in InputParagraph) {
	out.RawByte('{')
	first := true
	_ = first
...
func easyjson8336a586DecodeGithubComMaterkovMeme9Web6Api10(in *jlexer.Lexer, out *InputArticle) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8336a586EncodeGithubComMaterkovMeme9Web6Api10(out *jwriter.Writer, in InputArticle) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != "" {
...
func easyjson8336a586DecodeGithubComMaterkovMeme9Web6Api11(in *jlexer.Lexer, out *Article) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "user":
			if in.IsNull() {
				...
				easyjson8336a586DecodeGithubComMaterkovMeme9Web6Api12(in, out.User)
			}
		case "createdAt":
...
func easyjson8336a586EncodeGithubComMaterkovMeme9Web6Api11(out *jwriter.Writer, in Article) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != "" {
	...
	if in.User != nil {
		...
		easyjson8336a586EncodeGithubComMaterkovMeme9Web6Api12(out, *in.User)
	}
	if in.CreatedAt != "" {
...
func easyjson8336a586DecodeGithubComMaterkovMeme9Web6Api12(in *jlexer.Lexer, out *User) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8336a586EncodeGithubComMaterkovMeme9Web6Api12(out *jwriter.Writer, in User) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != "" {
